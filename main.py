...
# Heading
w2 = Label(root, justify=LEFT, text="Disease prediction System", fg="Black", bg="red")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="Project Members Akash Bhosale, Sarthak Hardas", fg="Black", bg="red")
